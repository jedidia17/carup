...
export default function ProctedLayout() {
    return (
        <div className="flex">
            <nav class="bg-background shadow-xl h-screen sticky top-0 left-0 min-w-[250px] py-6 font-[sans-serif] overflow-auto">
                <div class="relative flex flex-col h-full">
                    ...
                    <div class="flex flex-wrap items-center cursor-pointer border-t border-gray-300 px-4 py-4">
                        <Avatar>
                            <AvatarImage src="https://github.com/shadcn.png" />
                            <AvatarFallback>JD</AvatarFallback>
                        </Avatar>
                        <div class="ml-4">
                            <p class="text-sm text-black">My Acount</p>
                            <p class="text-xs text-gray-500 mt-0.5">Active free account</p>
                        </div>
                    </div>
                </div>
            </nav>
